...
if  args.model_type in ['bpe', 'unigram']:
    assert args.vocab_size != "", "You forgot to specify 'vocab_size'!"
...
if args.mode == 'train':
    ...
    if args.model_type == 'morf' :
        ...
        encode = lambda x: morf.encode_morf(x)
        decode = lambda x: morf.decode_morf(x)
